...
// sections
import { UserTableToolbar, UserTableRow } from '../../../sections/@admin/user/list';
...
UserListPage.getLayout = (page: React.ReactElement) => <AdminLayout>{page}</AdminLayout>;
