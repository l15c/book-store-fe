...
// _mock
import { _folders, _files } from 'src/_mock/arrays';
// layouts
...
} from 'src/sections/@admin/general/file';
import { FilePanel, FileFolderCard, FileNewFolderDialog } from 'src/sections/@admin/file';
...
GeneralFilePage.getLayout = (page: React.ReactElement) => <AdminLayout>{page}</AdminLayout>;
